...
## What it does
This skill is defined in [`SKILL.md`](./SKILL.md). It is used for: - User asks whether SOUL.md / user.md / .hermes.md is customized, present, or correct.
...
- Setting up or repairing a user's con...
